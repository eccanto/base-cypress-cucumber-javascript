...
Given('I fill the search input with the {string} term on the Duckduckgo page', (text) => {
...
Then('the text {string} should be visible on the result page on the Duckduckgo page', (text) => {
    cy.get('#links', { timeout: 20000 }).should('be.visible').then(($elem) => {
